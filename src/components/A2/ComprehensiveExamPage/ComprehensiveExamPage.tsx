        ...
        <div className="mb-8 flex flex-col md:flex-row md:items-end justify-between gap-6">
          ...
          <div className="flex flex-col items-end gap-3">
            ...
            <p className="text-xs font-black text-slate-400 dark:text-neutral-500 uppercase tracking-widest">
              Page{" "}
              <span className="text-violet-600">{currentPageIndex + 1}</span> of{" "}
              {examPages.length}
            </p>
          </div>
        </div>
        ...
        <div className="bg-slate-50 dark:bg-slate-900 rounded-[2rem] md:rounded-[2.5rem] shadow-3xl border border-slate-200 dark:border-white/5 overflow-hidden relative">
                            ...
                            {Array.isArray(q.correctAnswer) ? (
                              q.correctAnswer.map((_, idx) => (
                                <input
                                  ...
                                  type="text"
                                  placeholder={`___`}
                                  className="px-3 py-2.5 md:px-5 md:py-3 rounded-xl md:rounded-2xl border-2 border-slate-200 dark:border-neutral-800 bg-white dark:bg-black focus:border-violet-500 dark:focus:border-violet-500 focus:ring-4 focus:ring-violet-500/10 outline-none transition-all w-full sm:w-32 text-center font-black text-base md:text-lg text-violet-600"
                              ...
                              <input
                                ...
                                className="px-3 py-2.5 md:px-5 md:py-3 rounded-xl md:rounded-2xl border-2 border-slate-200 dark:border-neutral-800 bg-white dark:bg-black focus:border-violet-500 dark:focus:border-violet-500 focus:ring-4 focus:ring-violet-500/10 outline-none transition-all w-full sm:w-64 text-center font-black text-base md:text-lg text-violet-600"
                                value={answers[q.id] || ""}
                                onChange={(e) =>
          ...
          <div className="p-2 md:p-10 bg-slate-100 dark:bg-neutral-900/50 border-t border-slate-200 dark:border-white/5 flex justify-between items-center">
            <button
              ...
              className="flex items-center gap-1.5 px-4 py-2.5 text-slate-500 dark:text-neutral-500 font-black disabled:opacity-30 hover:text-violet-600 transition-all text-xs md:text-sm uppercase tracking-widest rounded-xl hover:bg-slate-200 dark:hover:bg-white/5"
            >
              <ChevronLeft size={18} />
              Back
            </button>
            ...
            {currentPageIndex < examPages.length - 1 ? (
              <button
                onClick={nextSection}
                className="flex items-center gap-2 px-6 py-3 bg-violet-600 text-white font-black rounded-xl md:rounded-2xl hover:bg-violet-700 shadow-xl shadow-violet-500/20 transition-all active:scale-95 text-xs md:text-sm uppercase tracking-widest"
              >
                Next
