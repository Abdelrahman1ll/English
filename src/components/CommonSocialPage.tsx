...
import { MessageCircle, Volume2, Search, BookOpen, LayoutGrid, Focus, type LucideIcon } from "lucide-react";
...
export function CommonSocialPage() {
  ...
  const CATEGORIES = useMemo(() => [
    ...
    "Surprise / Unexpected",
    "Breaking the Ice",
    "Health & Happiness (Positive)",
    "Status Updates (Busy / Neutral)",
    "Expressing Heavy Busyness",
    "Social",
    "Common",
    "Travel",
  ...
  }, [sentencesData, searchQuery, CATEGORIES]);
    ...
    <div className="max-w-5xl mx-auto space-y-12 animate-in fade-in duration-500 pb-20">
      <div className="border-b border-white/5 pb-6">
        ...
        <p className="text-neutral-400 mt-4 text-lg">
          Phrases for social interactions, troubleshooting communication, and
          daily life.
        </p>
      </div>
        ...
        <>
          ...
          {Object.entries(groupedSentences).length > 0 ? (
                      ...
                      {items.map((sentence: SentenceItem, index: number) => (
                        ...
                        >
                          ...
                          <div className="space-y-3">
                            <h3
                              className={`text-xl font-bold transition-colors leading-tight ${activeWord === sentence.english ? "text-emerald-400" : "text-white group-hover:text-emerald-400"}`}
                            >
                              {sentence.english}
                            </h3>
                            <p
            ...
            <div className="text-center py-20 bg-[#1a1a1a] rounded-[3rem] border border-dashed border-white/10 max-w-2xl mx-auto">
              <BookOpen
                className="mx-auto text-neutral-700 mb-6 underline decoration-emerald-500/20 decoration-8 underline-offset-8"
                size={64}
              />
