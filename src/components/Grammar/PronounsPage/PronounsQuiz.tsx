      ...
      <div className="bg-purple-500/5 border border-purple-500/10 p-8 rounded-4xl shadow-xl">
        <div className="flex items-center gap-3 mb-6">
          ...
          <h2 className="text-2xl font-black text-white uppercase tracking-wider flex items-center gap-2">
            Subject Pronouns Quiz <span className="text-purple-400/50 font-arabic text-lg">(اختبار الضمائر)</span>
          </h2>
        </div>
            ...
            return (
              ...
              >
                ...
                <div className="space-y-1 mt-2">
                  ...
                  {q.translation && (
                    <p className="text-neutral-500 font-arabic text-sm" dir="rtl">
                      {q.translation}
                    </p>
                  )}
                </div>
