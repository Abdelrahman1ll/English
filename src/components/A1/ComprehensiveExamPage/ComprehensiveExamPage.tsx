                            ...
                            {Array.isArray(q.correctAnswer) ? (
                              q.correctAnswer.map((_, idx) => (
                                <input
                                  ...
                                  type="text"
                                  placeholder={`___`}
                                  className="px-5 py-3 rounded-2xl border-2 border-slate-200 dark:border-neutral-800 bg-white dark:bg-black focus:border-blue-500 dark:focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 outline-none transition-all w-32 text-center font-black text-lg text-blue-600"
