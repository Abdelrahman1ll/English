  ...
  return (
    <div className="max-w-3xl mx-auto w-full animate-in slide-in-from-bottom-4 duration-500">
      <div className="space-y-6 pb-10">
        ...
        <div className="relative max-w-xl mx-auto mb-4 px-4 sm:px-0">
        ...
        <div className="relative group min-h-[450px]">
          ...
          <div className="relative bg-[#1a1a1a] border border-white/10 rounded-[3rem] p-6 sm:p-8 md:p-12 shadow-2xl space-y-6 sm:space-y-10 h-full flex flex-col justify-center text-center">
            {/* Category & Peek */}
            <div className="flex items-center justify-between gap-2 px-1">
              ...
              {currentItem.category && (
                <span className="flex-1 min-w-0 px-3 py-1.5 bg-blue-500/10 text-blue-400 rounded-full text-[9px] sm:text-xs font-black uppercase tracking-[0.1em] sm:tracking-widest truncate text-center mx-2">
                  {currentItem.category}
                </span>
              )}
              ...
              <div className="flex-none">
                <button
                  ...
                  className={`p-3 rounded-full transition-all duration-300 relative group/eye ${
                    isWordVisible
            ...
            <div className="space-y-6">
              ...
              >
                ...
                <div
                  className={`relative p-8 rounded-full border transition-all duration-300 ${playingItem === (currentItem.audio || currentItem.primary) ? "bg-blue-600 border-blue-500 scale-110 shadow-2xl shadow-blue-600/40" : "bg-neutral-800 border-white/5 group-hover/btn:border-blue-500/50 group-hover/btn:scale-105"}`}
                >
                  <Volume2
                    size={48}
                    className={
              ...
              <div className="relative">
                <h2
                  className={`text-4xl md:text-5xl font-black text-white leading-tight tracking-tight transition-all duration-500 ${shouldHide ? "opacity-0 blur-xl scale-95" : "opacity-100 blur-0 scale-100"}`}
                >
                  {currentItem.primary}
                </h2>
                {shouldHide && (
            ...
            {/* Arabic Translation */}
            <div className="pt-4">
              <p className="text-2xl md:text-3xl text-neutral-400 font-arabic dir-rtl leading-relaxed">
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between px-4">
            <label className="text-sm font-bold text-neutral-500 uppercase tracking-widest">
          ...
          <input
            ...
            onBlur={() => {}}
            className={`w-full bg-[#1a1a1a]/50 border rounded-2xl py-6 px-8 text-xl transition-all focus:outline-hidden focus:ring-4 focus:ring-blue-500/20 ${
              isCorrect
            ...
            <div className="animate-in fade-in zoom-in duration-500 py-4">
              <div className="flex flex-col items-center gap-3">
                <div className="relative">
                  ...
                  <div className="relative w-16 h-16 rounded-full bg-[#1a1a1a] border border-rose-500/40 flex items-center justify-center shadow-xl">
        ...
        <div className="flex items-center justify-center gap-6 pt-4">
          <button
            ...
            className="p-5 rounded-3xl bg-[#1a1a1a] border border-white/5 text-white disabled:opacity-30 disabled:cursor-not-allowed hover:bg-neutral-800 transition-all hover:scale-105 active:scale-95"
          >
            <ChevronLeft size={32} />
          </button>
          <div className="px-8 py-4 bg-black/40 border border-white/10 rounded-2xl backdrop-blur-xl">
            <span className="text-2xl font-black text-blue-400">
              {currentIndex + 1}
            </span>
            <span className="text-neutral-600 font-bold mx-3">/</span>
            <span className="text-neutral-500 font-bold">{items.length}</span>
          </div>
          <button
            onClick={handleNext}
            disabled={currentIndex === items.length - 1}
            className="p-5 rounded-3xl bg-[#1a1a1a] border border-white/5 text-white disabled:opacity-30 disabled:cursor-not-allowed hover:bg-neutral-800 transition-all hover:scale-105 active:scale-95 shadow-xl"
          >
