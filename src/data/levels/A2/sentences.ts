...
export const TELLING_TIME_PHRASES = [
  ...
  { english: "The time is fifteen or thirty minutes past the hour", arabic: "لو الساعة 3 وربع أو ونص.. هنقول", category: "Time", icon: MessageCircle },
  ...
  { english: "The time is forty minutes past the hour", arabic: "لو عايز تقول الساعة إلا تلت", category: "Time", icon: MessageCircle },
  ...
  { english: "The time is forty-five past the hour", arabic: "لو الساعة إلا ربع", category: "Time", icon: MessageCircle },
  ...
  { english: "The time is fifty minutes past the hour", arabic: "لو الساعة إلا 10", category: "Time", icon: MessageCircle },
  ...
  { english: "When a timepiece is not accurate:", arabic: "لما الساعة متكنش دقيقة / صح", category: "Time", icon: MessageCircle },
  ...
  { english: "How to ask which day of the week", arabic: "لما تعوز تسأل أنت في أي يوم من الأسبوع", category: "Time", icon: MessageCircle },
  ...
  { english: "How to answer which day of the week", arabic: "إزاي تجاوب على سؤال احنا في يوم إيه", category: "Time", icon: MessageCircle },
