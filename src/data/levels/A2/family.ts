...
export const FAMILY: VocabularyItem[] = [
  ...
  { english: "Divorced", arabic: "مطلق - مطلقة", note: "adj" },
  { english: "Widower", arabic: "أرمل", note: "n" },
  { english: "Fiance", arabic: "خطيب", note: "n" },
  { english: "Fiancee", arabic: "خطيبة", note: "n" },
  { english: "Engaged", arabic: "مرتبط", note: "adj" },
  ...
  { english: "Acquaintances", arabic: "معارف أو أشخاص تعرفهم بشكل سطحي", note: "n" },
  { english: "Adoption", arabic: "التبني", note: "n" },
  { english: "Adopt", arabic: "يتبنى", note: "v" },
  { english: "Ancestors", arabic: "السلف / الأجداد (أبعد من الأجداد)", note: "n" },
