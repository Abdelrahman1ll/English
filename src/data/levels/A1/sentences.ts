...
export const GREETINGS_DATA = [
  {
    ...
    items: [
      ...
      { text: "Howdy!", translation: "هلا! / مرحبًا!", note: "Casual (US)" },
      { text: "Hey!", translation: "هاي", note: "Casual" },
      { text: "Yo!", translation: "يو! / أهلًا!", note: "Very Casual" },
    ],
  },
  {
    ...
    items: [
      ...
      { text: "How've you been?", translation: "كيف كان حالك؟", note: "Long time no see" },
      { text: "What's new?", translation: "ما الجديد ؟" },
      { text: "What's up?", translation: "ما أخبارك ؟ (عامية)" },
      { text: "What's happening?", translation: "ماذا يحدث؟ (عامية)", note: "Casual" },
      { text: "What's going on?", translation: "ما الذي يجري؟ (عامية)", note: "Casual" },
    ],
  },
  {
    title: "Time-Based",
    ...
    items: [
      ...
      { text: "Morning", translation: "صباحًا (مختصرة)", note: "Short form" },
      { text: "Good afternoon", translation: "تحية وقت الظهيرة" },
      { text: "Good evening", translation: "تحية المساء" },
      { text: "Evening", translation: "مساءً (مختصرة)", note: "Short form" },
      { text: "How are you this bright morning?", translation: "كيف حالك في هذا الصباح المشرق؟", note: "Poetic/Friendly" },
    ],
  },
  {
