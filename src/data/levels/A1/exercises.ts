...
export const GRAMMAR_TESTS = [
  ...
  },
  {
    ...
    questions: [
      ...
      {
        question: "He ___ inside the house.",
        options: ["am", "is", "are"],
        answer: "is",
      },
      {
      ...
      {
        question: "Grandma ___ here.",
        options: ["am", "is", "are"],
        answer: "is",
      },
      {
        question: "Grass ___ green.",
        options: ["am", "is", "are"],
        answer: "is",
      },
      {
      ...
      {
        question: "___ the sea blue?",
        options: ["Am", "Is", "Are"],
        answer: "Is",
      },
      {
        question: "New York ___ a city in the USA.",
        options: ["am", "is", "are"],
        answer: "is",
      },
      {
        question: "Canada ___ north of the USA.",
        options: ["am", "is", "are"],
        answer: "is",
      },
      {
        question: "A horse ___ an animal.",
        options: ["am", "is", "are"],
        answer: "is",
      },
      {
        question: "The bike ___ from my father.",
        options: ["am", "is", "are"],
        answer: "is",
      },
      {
        question: "The poster ___ from John.",
        options: ["am", "is", "are"],
        answer: "is",
      },
      {
        question: "The plane ___ late.",
        options: ["am", "is", "are"],
        answer: "is",
      },
      {
      ...
      {
        question: "Nobody ___ here.",
        options: ["am", "is", "are"],
        answer: "is",
      },
      {
        question: "John, Mike and Bo ___ sick.",
        options: ["am", "is", "are"],
        answer: "are",
      },
      {
        question: "An egg ___ white and yellow.",
        options: ["am", "is", "are"],
        answer: "is",
      },
      {
        question: "Rome ___ the capital city of Italy.",
        options: ["am", "is", "are"],
        answer: "is",
      },
      {
        question: "Beans ___ green.",
        options: ["am", "is", "are"],
        answer: "are",
      },
      {
        question: "They ___ healthy.",
        options: ["am", "is", "are"],
        answer: "are",
      },
      { question: "I ___ hungry.", options: ["am", "is", "are"], answer: "am" },
      {
        question: "Sylvia ___ in love with Bob.",
        options: ["am", "is", "are"],
        answer: "is",
      },
      {
        question: "The queen ___ fat.",
        options: ["am", "is", "are"],
        answer: "is",
      },
    ],
  ...
  {
    id: "g2_2",
    title: "Verb To Be (Part 2)",
    description: "More practice with am, is, are.",
    type: "fill-blanks",
    questions: [
      {
        question: "The king ___ strong.",
        options: ["am", "is", "are"],
        answer: "is",
      },
      {
        question: "You ___ brave.",
        options: ["am", "is", "are"],
        answer: "are",
      },
      {
        question: "They ___ mad.",
        options: ["am", "is", "are"],
        answer: "are",
      },
      {
        question: "Coffee ___ hot.",
        options: ["am", "is", "are"],
        answer: "is",
      },
      {
        question: "Ice-cream ___ cold.",
        options: ["am", "is", "are"],
        answer: "is",
      },
      {
        question: "Pancakes ___ good.",
        options: ["am", "is", "are"],
        answer: "are",
      },
      {
        question: "It ___ a super job!",
        options: ["am", "is", "are"],
        answer: "is",
      },
      {
        question: "Scott ___ a boy.",
        options: ["am", "is", "are"],
        answer: "is",
      },
      {
        question: "He ___ seven years old.",
        options: ["am", "is", "are"],
        answer: "is",
      },
      {
        question: "Maria ___ a girl.",
        options: ["am", "is", "are"],
        answer: "is",
      },
      {
        question: "She ___ Scott's sister.",
        options: ["am", "is", "are"],
        answer: "is",
      },
      {
        question: "You ___ in my house.",
        options: ["am", "is", "are"],
        answer: "are",
      },
      {
        question: "I like it when you ___ here.",
        options: ["am", "is", "are"],
        answer: "are",
      },
      {
        question: "He ___ a good footballer.",
        options: ["am", "is", "are"],
        answer: "is",
      },
      {
        question: "They ___ from Germany.",
        options: ["am", "is", "are"],
        answer: "are",
      },
      {
      ...
      {
        question: "Tinker ___ a dog.",
        options: ["am", "is", "are"],
        answer: "is",
      },
      {
        question: "He ___ my dog.",
        options: ["am", "is", "are"],
        answer: "is",
      },
      {
        question: "A football ___ often white.",
        options: ["am", "is", "are"],
        answer: "is",
      },
      {
        question: "It ___ my bike.",
        options: ["am", "is", "are"],
        answer: "is",
      },
      {
        question: "Muzzy ___ a monster.",
        options: ["am", "is", "are"],
        answer: "is",
      },
      {
  ...
  {
    id: "g7",
    title: "Pronouns (Substitutions)",
    description: "Choose the correct pronoun for the underlined words.",
    type: "multiple-choice",
    questions: [
      {
      ...
      {
        question: "Ali and Ahmed are playing football.",
        options: ["He", "She", "It", "They"],
        answer: "They",
      },
    ],
...
export const VOCAB_TESTS = [
  ...
  },
  {
    ...
    questions: [
      {
        question: "How do you say 'فرحان' in English?",
